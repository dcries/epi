...
start$currentbeta <- c(19.06,7.41,2.57,0.26,8.18,1.63,0.56,4,2.36,24.79,7.45,1.51,-0.36,2.2,-0.312)
start$currentlambda <- start$currentlambda * 1.5
start$Sigmadiag <- start$Sigmadiag * 1.5
...
save(out3,file="/home/dcries/stanout_realmix3c.RData")
