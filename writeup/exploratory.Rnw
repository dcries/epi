...
lme1 <- lme(modvigmin~as.factor(dow)+as.factor(rep),random=~1|id,data=meas7,correlation=corSymm(form=~1|id),weight = varIdent(form = ~ 1|rep),method="ML",control=list(msMaxIter=100))

lme2 <- lme(modvigmin~as.factor(dow)+as.factor(rep),random=~1|id,data=meas57,correlation=corSymm(form=~1|id),weight = varIdent(form = ~ 1|rep),method="ML",control=list(msMaxIter=100))

lme3 <- lme(modvigmin~as.factor(dow)+as.factor(rep),random=~1|id,data=meas67,correlation=corSymm(form=~1|id),weight = varIdent(form = ~ 1|rep),method="ML",control=list(msMaxIter=100))
@
