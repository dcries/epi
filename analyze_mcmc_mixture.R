...
wlam <- colMeans(out5$lambda[,1,]) - mean(out5$lambda[,1,])
...
glam <- colMeans(out5$lambda[,2,]) - mean(out5$lambda[,2,])
...
tlam <- colMeans(out5$lambda[,3,]) - mean(out5$lambda[,3,])
...
bpslam <- colMeans(out5$lambda[,4,]) - mean(out5$lambda[,4,])
...
bpdlam <- colMeans(out5$lambda[,6,]) - mean(out5$lambda[,6,])
...
llam <- colMeans(out5$lambda[,5,]) - mean(out5$lambda[,5,])
...
hlam <- colMeans(out5$lambda[,7,]) - mean(out5$lambda[,7,])
